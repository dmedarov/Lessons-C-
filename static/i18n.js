const bg = {
  ...
  "admin.rejectBody": "Добави причина за отказа (незадължително). Служителят ще получи известие.",
  ...
  "confirm.bulkReject": "Добави причина за batch отказа. Тя ще бъде видима в lifecycle историята.",
