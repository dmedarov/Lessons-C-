...
COPY --chown=10001:10001 app.py app_settings.py bootstrap_tokens.py config.py container_entrypoint.py db.py netfleet_service.py notifications_service.py production_readiness.py rate_limit.py security.py schemas.py ./
