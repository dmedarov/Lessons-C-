...
ARG PYTHON_BUILDER_IMAGE=python:3.14.4-slim
...
COPY --chown=10001:10001 app.py config.py container_entrypoint.py db.py notifications_service.py rate_limit.py security.py schemas.py ./
