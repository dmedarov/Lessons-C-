...
- `evidence`: latest local handoff check ran `make qa-premium` -> dependency
  audit, secret scan, Python compile, 170 pytest cases, JS syntax and 16 Playwright browser
