...
- `evidence`: latest local handoff check ran `make qa-premium` -> dependency
  audit, Python compile, 148 pytest cases, JS syntax and 11 Playwright browser
