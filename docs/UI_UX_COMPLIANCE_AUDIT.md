...
- `evidence`: latest local handoff check ran `make qa-premium` -> dependency
  audit, Python compile, 164 pytest cases, JS syntax and 14 Playwright browser
