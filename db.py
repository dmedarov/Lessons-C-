...
SQLITE_SCHEMA = [
    ...
    CREATE TABLE IF NOT EXISTS users (
        ...
        role TEXT NOT NULL CHECK(role IN ('employee','fleet_approver','fleet_reception','fleet_admin')),
    ...
    CREATE TABLE IF NOT EXISTS car_assignments (
        ...
        assignment_mode TEXT NOT NULL
            CHECK(assignment_mode IN ('manual','quick_book','suggested','auto')),
    ...
    "CREATE INDEX IF NOT EXISTS idx_car_assignments_reservation ON car_assignments(reservation_id)",
    "CREATE INDEX IF NOT EXISTS idx_car_assignments_car_created ON car_assignments(car_id, created_at DESC)",
]
...
POSTGRES_SCHEMA = [
    ...
    CREATE TABLE IF NOT EXISTS car_assignments (
        ...
        reservation_id INTEGER NOT NULL REFERENCES reservations(id),
        car_id INTEGER NOT NULL REFERENCES cars(id),
        assignment_mode TEXT NOT NULL CHECK(assignment_mode IN ('manual','quick_book','suggested','auto')),
